...
export default function Faq() {
    ...
    return (
        <div className="relative h-[950px] grid grid-cols-1 lg:grid-cols-2 p-6 lg:p-44 z-[3]">
            ...
            <div className="z-[2] m-auto font-semibold lg:font-bold text-md lg:text-xl select-none transition-all">
                <div onClick={() => handleBoxClick(1)} className={currentBox != 1 ? "bg-[#8f6464] h-12 w-[300px] lg:w-[600px] px-4 py-[10px] rounded-xl transition-all relative visible my-2" : "bg-[#b18181] h-64 w-[300px] lg:w-[600px] p-5 rounded-xl items-center transition-all relative visible"}>
                ...
                <div onClick={() => handleBoxClick(2)} className={currentBox != 2 ? "bg-[#8f6464] h-12 w-[300px] lg:w-[600px] px-4 py-[10px] rounded-xl transition-all relative visible my-2" : "bg-[#b18181] h-64 w-[300px] lg:w-[600px] p-5 rounded-xl items-center transition-all relative visible"}>
                ...
                <div onClick={() => handleBoxClick(3)} className={currentBox != 3 ? "bg-[#8f6464] h-12 w-[300px] lg:w-[600px] px-4 py-[10px] rounded-xl transition-all relative visible my-2" : "bg-[#b18181] h-64 w-[300px] lg:w-[600px] p-5 rounded-xl items-center transition-all relative visible"}>
                ...
                <div onClick={() => handleBoxClick(4)} className={currentBox != 4 ? "bg-[#8f6464] h-12 w-[300px] lg:w-[600px] px-4 py-[10px] rounded-xl transition-all relative visible my-2" : "bg-[#b18181] h-64 w-[300px] lg:w-[600px] p-5 rounded-xl items-center transition-all relative visible"}>
                ...
                <div onClick={() => handleBoxClick(5)} className={currentBox != 5 ? "bg-[#8f6464] h-12 w-[300px] lg:w-[600px] px-4 py-[10px] rounded-xl transition-all relative visible my-2" : "bg-[#b18181] h-64 w-[300px] lg:w-[600px] p-5 rounded-xl items-center transition-all relative visible"}>
                ...
                <div onClick={() => handleBoxClick(6)} className={currentBox != 6 ? "bg-[#8f6464] h-12 w-[300px] lg:w-[600px] px-4 py-[10px] rounded-xl transition-all relative visible my-2" : "bg-[#b18181] h-64 w-[300px] lg:w-[600px] p-5 rounded-xl items-center transition-all relative visible"}>
