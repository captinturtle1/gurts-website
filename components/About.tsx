...
export default function About() {
  return (
    <div id="About" className="relative h-[900px] grid grid-cols-1 lg:grid-cols-2 z-[3]">
        ...
        <img src="milkbox.png" className="absolute w-12 lg:w-24 top-80 lg:top-32 right-32 lg:right-32 animate-wiggle scroll-smooth"/>
        <div className="relative mx-10 lg:mx-24 my-10 lg:my-36">
          ...
          <img src="Ex2.png" className="absolute min-w-[150px] top-[20%] lg:top-[20%] left-[48%] lg:left-[45%] w-[25%] lg:w-[50%] max-w-[400px] rounded-full drop-shadow-lg"/>
        ...
        <div className="flex gap-10 p-10 lg:p-0 my-auto z-[2]">
